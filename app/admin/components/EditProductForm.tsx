                    ...
                    {mediaItems.map((m, index) => {
                        ...
                        return (
                            <View key={index} style={styles.mediaCard}>
                                    ...
                                    if (fileType === 'image' || fileType === 'gif') {
                                        ...
                                        return (
                                            <View style={styles.mediaPlaceholderContainer}>
                                                <Ionicons name="play-circle" size={40} color="#2D4B34" />
                                        ...
                                        return (
                                            <View style={styles.mediaPlaceholderContainer}>
                                                <Ionicons name="document-text" size={40} color="#2D4B34" />
                                ...
                                <View style={[styles.mediaTypeBadge, { backgroundColor: m.isNew ? '#2D4B34' : '#15803D' }]}>
